...
@section('content')
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Expense Management > Expense Categories</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col">
            <span class="btn-group float-right" style="cursor: pointer; color:#eee">
                <a data-toggle="modal" data-target="#add_category_modal" class="btn btn-md btn-success mr-2">Add
                    Category</a>
            </span>
        </div>
    </div>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuSplitButton2">
                                                    ...
                                                    <a class="dropdown-item" id="update_modal_show" style="cursor: pointer"
                                                        onclick="getCategoryInfo({{ $value->id }})">Update</a>
                                                    <a class="dropdown-item" style="cursor: pointer"
                                                        onclick="deleteCategory({{ $value->id }})">Delete</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                ...
                                <input type="text" placeholder="Enter Category Name Here.." class="form-control"
    ...
    <div class="modal fade" id="update_category_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                ...
                                <label>Category Name</label>
                                <input type="text" placeholder="Enter Category Name Here.." class="form-control"
                                    name="category" value="{{ old('category') }}" id="category_info">
                            </div>
                        </div>
